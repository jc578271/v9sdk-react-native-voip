...
- (NSDictionary *)toJsonDictionary:(bool) isSpeaker {
    ...
    return @{
        @"id": @(self.id),
        @"callId": [V9SipUtil toString:&info.call_id],
        @"accountId": @(info.acc_id),
        
        @"localContact": [V9SipUtil toString:&info.local_contact],
        @"localUri": [V9SipUtil toString:&info.local_info],
        @"remoteContact": [V9SipUtil toString:&info.remote_contact],
        @"remoteUri": [V9SipUtil toString:&info.remote_info],
        @"state": [V9SipUtil callStateToString:info.state],
        @"stateText": [V9SipUtil toString:&info.state_text],
        @"connectDuration": @(connectDuration),
        @"totalDuration": @(info.total_duration.sec),
        
        @"lastStatusCode": [V9SipUtil callStatusToString:info.last_status],
        @"lastReason": [V9SipUtil toString:&info.last_status_text],
...
- (NSDictionary *)mediaToJsonDictionary:(pjsua_call_media_info) info {
    return @{
        @"dir": [V9SipUtil mediaDirToString:info.dir],
        @"type": [V9SipUtil mediaTypeToString:info.type],
        @"status": [V9SipUtil mediaStatusToString:info.status],
        @"audioStream": @{
